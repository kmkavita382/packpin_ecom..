...
// Assuming all necessary imports are correctly set
// Minor optimizations for readability and maintenance
...
// const PaymentMethodOption = ({ method, src, alt, selected, onClick }) => (
//     <div onClick={onClick} className={`w-[20%] border-r cursor-pointer py-8 px-12 ${selected ? 'bg-white' : 'bg-slate-100'}`}>
//         <div className='flex flex-col gap-[3px] justify-center items-center'>
//             <img src={src} alt={alt} />
...
//                               <div className='pr-2 md:pr-0'>
//                                   <div className='flex flex-wrap'>
//                                       {['stripe', 'bkash', 'nogot', 'roket'].map((method) => (
//                                         <PaymentMethodOption
//                                           key={method}
//                                           method={method.charAt(0).toUpperCase() + method.slice(1)}
//                                           src={`http://localhost:3000/images/payment/${method}.png`}
//                                           alt={method}
